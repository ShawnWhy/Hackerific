...
//build a user array with name, id and socket id and color
//when a user connects, add them to the array
//when a user disconnects, remove them from the array
//when a user sends a message, send it to all users
var users = [];
